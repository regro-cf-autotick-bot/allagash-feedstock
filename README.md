...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/allagash-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14894&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/allagash-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `allagash` can be installed with:

```
conda install allagash
```

It is possible to list all of the versions of `allagash` available on your platform with:
